...
**Design review site:**
[kelsus.github.io/open-miyota-9075-gmt-case](https://kelsus.github.io/open-miyota-9075-gmt-case/)
shows the current revision with renders, the full spec table, and the
verification status. It is `docs/index.html`, regenerated by
`build_review.py` from the same model as everything else.
...
| `render.py`, `build_review.py` | Preview renders and the single-file design review page (`docs/index.html`, served by GitHub Pages). |
